...
class BukuRusakController extends Controller
{
    public function index()
    {
		...
		return view('Pengurus.Admin.page.buku.data-buku-rusak.main',compact('title','page','buku'));
    }
    ...
    public function tambah()
    {
		...
		return view('Pengurus.Admin.page.buku.data-buku-rusak.form-buku-rusak',compact('title','page','buku','data_buku'));
    }
    ...
    public function edit($id)
    {
		...
		return view('Pengurus.Admin.page.buku.data-buku-rusak.form-buku-rusak',compact('title','page','buku','data_buku','row'));
    }
    ...
    public function save(Request $request)
    {
		...
		return redirect('/admin/data-buku-rusak')->with('message',$message);
    }
    ...
    public function delete($id)
    {
    	...
    	return redirect('/admin/data-buku-rusak')->with('message','Berhasil Hapus Data');
    }
}
