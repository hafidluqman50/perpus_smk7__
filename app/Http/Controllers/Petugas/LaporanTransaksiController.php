...
class LaporanTransaksiController extends Controller
{
    public function index()
    {
    	...
    	return view('Pengurus.Petugas.page.buku.laporan.main',compact('title','page','buku','tahun_ajaran'));
    }
    ...
    public function cetakTransaksi(Request $request) 
    {
        ...
        $spreadsheet->getActiveSheet()->setCellValue('G31',Petugas::where('jabatan','kepala-perpustakaan')->firstOrFail()->nama_petugas);
        $spreadsheet->getActiveSheet()->setCellValue('G32','NIP.'.Petugas::where('jabatan','kepala-perpustakaan')->firstOrFail()->nip);
