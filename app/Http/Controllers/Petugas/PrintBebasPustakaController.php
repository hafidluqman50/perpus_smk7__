...
class PrintBebasPustakaController extends Controller
{
    ...
    {
		$title         = 'Print Bebas Pustaka | Petugas';
    	...
    	return view('Pengurus.Petugas.page.buku.print-bebas-pustaka.main',compact('title','page','buku','tahun_ajaran','kelas_tingkat','jurusan'));
    }
    ...
    public function cetakSurat(Request $request)
    {
        ...
        return view('Pengurus.Petugas.page.buku.print-bebas-pustaka.bebas-pustaka',compact('get_siswa','nomor_surat','kepala_perpus'));
    }
}
