			...
			<div class="col-md-12">
				<div class="card">
					<div class="card-header">
						<a href="{{ url('/admin/data-anggota/guru/tambah') }}">
					...
					<div class="card-body">
						...
						@endif
						<table class="table force-fullwidth data-guru">
							<thead>
								<tr>
									<th scope="col">No.</th>
									<th scope="col">NIP</th>
...
<script>
    ...
    $(function(){
        var guru = $('.data-guru').DataTable({
            processing:true,
            serverSide:true,
            ajax:"{{ url('/datatables/data-anggota/guru') }}",
            columns:[
        ...
        guru.on( 'order.dt search.dt', function () {
	        guru.column(0, {search:'applied', order:'applied'}).nodes().each( function (cell, i) {
	        	cell.innerHTML = i+1;
	        });
        }).draw();
    });
