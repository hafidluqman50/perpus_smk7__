			...
			<div class="col-md-12">
				<div class="card">
					<div class="card-header">
						<form action="{{ url('/petugas/data-buku/cetak') }}" method="GET">
							<div class="row">
								<div class="col-md-3">
				...
				<div class="card">
					<div class="card-header">
						<form action="{{ url('/petugas/transaksi-buku/cetak-laporan-buku') }}" method="GET">
							<div class="row">
								<div class="col-md-3">
									<div class="form-group">
										<select name="tahun_ajaran" class="form-control select2">
				...
				<div class="card">
					<div class="card-header">
						<form action="{{ url('/petugas/transaksi-buku/cetak-laporan-buku-k13') }}" method="GET">
							<div class="row">
								<div class="col-md-3">
									<div class="form-group">
										<select name="tahun_ajaran" class="form-control select2">
