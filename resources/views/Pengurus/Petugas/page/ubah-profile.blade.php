		...
		<div class="row">
			<div class="col-md-12">
				<div class="card">
					...
					@endif
					<form action="{{ url('/petugas/ubah-profile/save') }}" method="POST" enctype="multipart/form-data" oninput="re_type_password.setCustomValidity(re_type_password.value != password.value ? 'Passwords do not match.' : '')">
						@csrf
						<div class="card-body">
