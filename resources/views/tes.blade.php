          ...
          <table role="presentation" style="width:94%;max-width:600px;border:none;border-spacing:0;text-align:left;font-family:Arial,sans-serif;font-size:16px;line-height:22px;color:#363636;">
            ...
            <tr>
              <td style="padding:30px;background-color:#ffffff;">
                ...
                <p style="margin:0;">Halo, Hafiidh Luqmanul Hakim</p>
                <br>
                <p style="margin:0;">Buku PHP yang kamu pinjam akan menuju deadline loh, harus dikembalikan tanggal 21 Januari 2021</p>
                <br>
            ...
            <tr>
              <td style="padding:30px;font-size:24px;line-height:28px;font-weight:bold;background-color:#ffffff;border-bottom:1px solid #f0f0f5;border-color:rgba(201,201,207,.35);">
                <img src="{{ asset('admin-assets/dist/ss_panduan.jpeg') }}" width="540" alt="" style="width:100%;height:auto;border:none;text-decoration:none;color:#363636;" draggable="false">
                <img src="{{ asset('admin-assets/dist/ss_panduan_2.png') }}" width="540" alt="" style="width:100%;height:auto;border:none;text-decoration:none;color:#363636;" draggable="false">
                <img src="{{ asset('admin-assets/dist/ss_panduan_3.png') }}" width="540" alt="" style="width:100%;height:auto;border:none;text-decoration:none;color:#363636;" draggable="false">
              </td>
            </tr>
            <tr>
              <td style="padding:0;font-size:24px;line-height:28px;font-weight:bold;">
                <a href="http://www.example.com/" style="text-decoration:none;"><img src="{{ asset('admin-assets/dist/16576.jpg') }}" width="600" alt="" style="width:100%;height:auto;display:block;border:none;text-decoration:none;color:#363636;"></a>
              </td>
            </tr>
            <!-- <tr>
              <td style="padding:30px;background-color:#ffffff;">
